...
public static void operationMenu() throws IOException {
    ...
    public static void transferMoney() throws IOException {
        ...
        OutputStreamWriter osw = new OutputStreamWriter(fOut);
            ...
            Scanner to_MyReader = new Scanner(toAccountDetailsFile);
            while (to_MyReader.hasNextLine()) {
                String data1 = to_MyReader.nextLine();
    ...
    public static void payUtilityBills() throws
        ...
        Scanner my_Reader = new Scanner(accountDetailsFile);
